...
const CREATE_NEWS_ARTICLE = gql`
    mutation CreateNewsArticle($newsArticleInput: NewsArticleInput) {
        createNewsArticle(newsArticleInput: $newsArticleInput) {
            title
            body
            excerpt
            image
...
function CreateNewsArticle(props) {
